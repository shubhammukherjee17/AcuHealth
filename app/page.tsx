...
function Chat() {
  ...
  return (
    <div className="flex flex-col flex-grow h-screen bg-[#343541] text-white md:px-28 relative">
      <SidebarTrigger className="absolute top-2 left-2 p-5" />
      <header className="flex-shrink-0 p-4 text-center">
        <h1 className="text-2xl md:text-4xl font-bold">AI Health Assistant</h1>
      </header>
